...
def sign_in():
    ...
    # tk.Label(second_win, text="",
    #      font=("Arial", 14), bg="#f0f0f0").pack(pady=10)

    entry_label1 = tk.Label(second_win, text="user name", font=("Arial", 12), bg="#f0f0f0")
    entry_label1.pack(pady=5)
    entry = tk.Entry(second_win, font=("Arial", 12), width=20)
    entry.pack(pady=5)

    entry_label1 = tk.Label(second_win, text="password", font=("Arial", 12), bg="#f0f0f0")
    entry_label1.pack(pady=5)
    entry = tk.Entry(second_win, font=("Arial", 12), width=20, show="*")
    entry.pack(pady=5)
